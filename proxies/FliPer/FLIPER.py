...
class ML:
    ...
    def PREDICTION(self, F02, F07, F7, F20, F50, noise, cadence, mission, path_to_training_file):
        """
        Estimation of logg/numax with machine learning (training given by 'ML_logg/numax_training_paper' to be dowload in GitHub).
        """
        listing         =   [{'lnF02': self.CONVERT_TO_LOG(F02), 
        ...
        columnsTitles   =   ['lnF02', 'lnF07', 'lnF7', 'lnF20', 'lnF50',
                             'noise', 'cadence', 'mission']
