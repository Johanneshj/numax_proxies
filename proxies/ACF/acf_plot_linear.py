...
def plot_spec_linear(frequency, power, smoothed_power, ax, id):
...
def plot_2D_ACF_linear(ACF, frequency, ax):
...
def plot_collapsed_acf_with_gaussian_fit_linear(collapsed_2D_acf, freq_centers, fit_vals, ax):
